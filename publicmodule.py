...
class FaceRecognition:
    ...
    def predict(self,img):
        ...
        img2,x1,y1,x2,y2 = getFace.getFace(img)
        ...
        print(prediction)
        img_result = cv2.rectangle(img_ori,(x1,y1),(x2,y2),(0,0,255))
        img_result = cv2.putText(img_result,str(prediction),(x1,y1),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale= 0.75,color=(0,0,255))
        return img_result
